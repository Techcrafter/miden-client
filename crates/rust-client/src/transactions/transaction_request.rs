...
pub struct TransactionRequest {
    ...
    /// Notes to be consumed that don't have an inclusion proof (and might not even be tracked by
    /// the client)
    ...
    /// Advice Map that will be used to execute the TX. (TODO: check doc comment)
